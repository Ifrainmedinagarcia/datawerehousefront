...
const ProfileUser = (props) => {
  ...
  const updateUser = async (e) => {
    ...
    try {
      ...
      await axios
        .put(
          `https://datawerehouse.herokuapp.com/v1/api/users/${userId}`,
          data,
          {
            headers: {
              Authorization: JWT,
  ...
  return (
    <>
      ...
      {message ? (
        <CustomizedSnackbars message="Foto de perfil actualizada" />
      ) : (
        ""
      )}
        ...
        <div className={classes.avatar}>
          ...
          {srcProps !== undefined ? (
            ...
            <img
              style={{ borderRadius: "200px" }}
              className={classes.absolute}
              src="https://imageprofileproject.s3.amazonaws.com/fotopredeterminada.png"
              alt="imageProfile"
            />
          )}
          <label
